  ...
  return (
    <section>
      <div className="max-w-[1170px] px-5 mx-auto">
        <div className="grid md:grid-clos-3 gap-[50px]">
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text_para leading-6 md:text-[15px] lg:max-w-[390px] ">
                   Lorem, ipsum dolor sit amet consectetur adipisicing elit. Earum, molestiae sapiente dignissimos 
                   dolores maxime tenetur voluptatum vitae quae cum repudiandae magnam deserunt perferendis vel 
                   exercitationem consequuntur nostrum accusamus excepturi neque?
                </p>
              </div>
              <div className="">
               <SidePanel />
