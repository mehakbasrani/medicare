...
const SignUp = () => {
  ...
  const submitHandler = async(event) =>{
    ...
    if(formData.userType == "Admin" && secretKey != "secretToken"){
      //event.preventDefault();
      toast("Invalid Admin")
      ...
      <div className="max-w-[1170px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            <h3 className="text=headingColor text-[22px] leading-5 font-bold mb-10">
            ...
            <div className="mb-5 flex">
              ...
              <input 
                ...
                <p className="text-textColor">User </p>
              <input 
                type="radio" 
                name="userType" 
                value="Admin" 
                className="mr-1 ml-5 text-textColor" 
                onChange = {handleInputChange}
                />
              <p className="text-textColor">Admin </p>
            </div>
