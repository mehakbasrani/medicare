               ...
               xl:gap-0 flex-col lg:flex-row">
                   <div className="relative w-3/4 lg:w-1/2 xl:w-[770px]
                     z-10 order-2 lg:order-1">
                         ...
                         <div className="absolute z-20 bottom-4 w-[200px] md:w-[300px] right-[-30%] ms:right-[-7%]
                           lg:right-[22%]">
                     ...
                     <div className="w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
                         ...
                         <p className="text-para">
                             For 30 years in a row, India News & World Report has recognised us as one of the best publics hospitals
                             in the Nation.
                         </p>
                         <p className="text-para mt-[30px]">
                             ...
                             but towards what we can do tomorrow. Providing the best.
                         </p>
                         <Link to="/">
